## Welcome to  [ # Image slider with multiple controls and mobile swipe control (Javascript) ]  HTML Code Sections

## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Image-Slider-with-Multiple-Controls-and-mobile-swipe-control )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/WNLZpam )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Image-Slider-with-Multiple-Controls-and-mobile-swipe-control )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/Image-Slider-with-Multiple-Controls-and-mobile-swipe-control/ )
